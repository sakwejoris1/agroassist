...
/* COUNT ADVISORIES */
$advisories = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) AS total FROM advisories"));
$total_advisories = $advisories['total'];

/* COUNT MARKET UPDATES */
$market = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) AS total FROM market_rates"));
